...
export class MeasureValueFilterLocalizationFR extends React.PureComponent {
    constructor(props) {
        super(props);
            ...
            <React.Fragment>
                ...
                <div style={{ height: 300 }} className="s-pivot-table">
                    <PivotTable
                        ...
                        rows={attributes}
                        filters={filters}
                        locale="fr-FR" // de-DE, es-ES, fr-FR, ja-JP, nl-NL, pt-BR, pt-PT, zh-Hans
                        config={{
                            menu: {
                                aggregations: true,
...
export default MeasureValueFilterLocalizationFR;
