...
export const mvfvisualizationsimplemeasureuri = `/gdc/md/${demoProjectId}/obj/10233`;
export const mvfvisualizationshowinpercentmeasureidentifier = `aag0qZnmgXBN`;
export const mvfvisualizationstacktopercentmeasureuri = `/gdc/md/${demoProjectId}/obj/10235`;
export const mvfvisualizationformattedinpercentmeasureidentifier = `aab0wjMwhHNU`;
export const mvfvisualizationAMchangemeasureuri = `/gdc/md/${demoProjectId}/obj/10237`;
export const mvfvisualizationAppliesFilterMeasureuri = `/gdc/md/${demoProjectId}/obj/10238`;
export const mvfvisualizationAppliesConfigMeasureuri = `/gdc/md/${demoProjectId}/obj/10239`;
